...
\newcommand{\classSemestr}{Spring 2017}
\newcommand{\classId}{GIS/MEA582}
\newcommand{\className}{Geospatial Modeling and Analysis}
\newcommand{\classWeb}{\url{http://ncsu-geoforall-lab.github.io/geospatial-modeling-course}}
...
% don't forget to replace \usepackage[demo]{graphicx} by \usepackage{graphicx}
\begin{figure}[htbp]
  \centering
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\oneimgwidth]{filename}
